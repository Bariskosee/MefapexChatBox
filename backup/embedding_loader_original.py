...
def load_faq_to_qdrant():
    """Load Turkish FAQ data with embeddings to Qdrant"""
    try:
        logger.info("Starting to load FAQ data to Qdrant...")
...
if __name__ == "__main__":
    try:
        ...
        print("✅ Embedding loader completed successfully!")
        print("FAQ data has been loaded to Qdrant and is ready for use.")
        
    except Exception as e:
        print(f"❌ Error: {e}")
        print("Please check your environment variables and Qdrant connection.")
