#!/usr/bin/env python3
"""
MEFAPEX Simple Working Server
Fixed version with all endpoints and proper error handling
"""
...
app = FastAPI(
    ...
    description="Working MEFAPEX ChatBox for login testing",
    version="1.0.0"
)
...
Başka bir konuda yardıma ihtiyacınız var mı?"""
        ...
        # Get anonymous response and personalize it
        anonymous_result = await chat_anonymous(message)
        response = f"👤 {username}: {anonymous_result.response}"
...
if __name__ == "__main__":
    print("🚀 Starting MEFAPEX Working Server...")
    print("📍 Demo credentials: username='demo', password='1234'")
    print("🌐 Access the application at: http://localhost:8000")
    print("🔧 Simple version at: http://localhost:8000/static/simple.html")
